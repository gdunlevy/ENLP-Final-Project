...
from keras.layers import Bidirectional, GRU, Conv1D, GlobalAveragePooling1D, MaxPooling1D, TimeDistributed, Dropout
from sklearn.metrics import precision_recall_fscore_support



homo1_data = 'semeval2017_task7/data/test/subtask1-homographic-test.xml'
homo1_result = 'semeval2017_task7/data/test/subtask1-homographic-test.gold'
